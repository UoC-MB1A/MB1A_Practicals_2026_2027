...
# Part 5 - Bonus: Sampling from a user-defined probability distribution {#sec-non_standard}
...
![Example data point](images/jethro1.jpeg){#fig-cataroo width="50%"}
...
![Example data point](images/jethro2.jpeg){#fig-cataroo width="50%"}
...
![Example data point](images/jethro3.jpeg){#fig-cataroo width="50%"}
...
![Example data point](images/jethro4.jpeg){#fig-cataroo width="50%"}
:::
:::
