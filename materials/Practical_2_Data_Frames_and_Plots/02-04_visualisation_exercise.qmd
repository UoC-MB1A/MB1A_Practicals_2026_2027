...
* Look at the dataframe and check that the data looks as expected.
...
```{r select_relevant_columns_visex}
...
```{r theme_etc_visex, fig.width=10, fig.height=4.5}
ggplot(
  loc_sum,
  aes(
    x = Longitude,
