...
library(gt)
library(tidyverse)
bird_breeding_exc <- read_csv("data/bird_breeding_exc.csv")
bird_migration_exc <- read_csv("data/bird_migration_exc.csv")
```

# Part 2: Complex Data Frame Operations {#sec-p2_complex_dataframe_operations}
...
```{r write_birds}
write_csv(combined_bird_piv, "data/combined_birds.csv")
```
