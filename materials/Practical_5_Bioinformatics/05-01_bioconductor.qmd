...
::: {.callout-exercise #ex_histo_beavers}
...
::: {.callout-answer #ex_histo_ans collapse="true"}
How long is the longest sequence?
...
::: {.callout-important}
Please choose any available region and put your CRSID next to it on the spreadsheet, so others know that it is taken. Each sequence has a unique ID, please note the ID for your sequence.
:::
