...
Repeat the steps above for each of the ORF sequences in your `identified_orf_df` data frame, so that you have one multiple sequence alignment for each gene.
...
Repeat the steps above for each of the ORF sequences in your `identified_orf_df` data frame, so that you have one Newick file for each gene. Save all of the alignments in NEWICK format with names formatted as above.
...
Repeat the steps above for each of the ORF sequences in your `identified_orf_df` data frame, so that you have one PDF tree for each gene.
