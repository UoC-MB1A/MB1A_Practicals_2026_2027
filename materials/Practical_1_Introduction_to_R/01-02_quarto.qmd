...
## Introduction to Quarto {#sec-quarto .core}
...
The main reason to use Quarto is to make your research **reproducible**. You will likely have learned about this previously for lab-based research, but reproducibility is just as important for computer-based research.
...
## Creating a Quarto document {#sec-creating_quarto .core}
...
![New quarto document](images/new_quarto.png){.screenshot #fig-new_quarto width="50%" fig-alt="The new Quarto document popup window. Document is selected in the left panel. The title is MB1A Practical 1 and the author is Katy Brown. HTML is selected, from the options of HTML, PDF or Word. Engine is knitr. Use visual markdown editor is unchecked. There are three buttons at the bottom, create empty document is on the left."}

You should see something like this:

![Empty quarto document](images/first_quarto.png){#fig-first_quarto .screenshot width="50%" fig-alt='A screenshot of the beginning of the empty Quarto document showing --- on line 1, title: "MB1A Practical 1" on line 2, author: "Katy Brown" on line 3, format: html on line 4 and --- on line 5.'}

In this document, we can combine code, text and images.

We can type explanatory text directly into the document.

To add code, click on the `Insert a New Code Chunk` ![Chunk button](../images/chunk_button.png){.inline-icon} button and choose `R`. Anything within this chunk will be interpreted as R code.

:::{.callout-exercise #ex-first_quarto .core}
...
Then, using the ![Chunk button](../images/chunk_button.png){.inline-icon} button, add the following code chunk.
...
![Run button](images/code_chunk.png){#fig-code_chunk fig-alt="Screenshot showing a code chunk with the run button - a small button with a play icon in the top right corner of the code chunk - highlighted"}
...
![Quarto document](images/quarto_doc.png){#fig-quarto_doc fig-alt="A screenshot of the whole Quarto document, which is available as plain text in data/quarto_doc.qmd"}
...
You can produce a report based on your document by clicking the `Render` button - ![Render button](../images/render_button.png){.inline-icon}. This runs all of the code and formats the document into **HTML** format, so it is easy to read and share. 

Save your document in the `{{< meta practical >}}` folder as `my_first_quarto.qmd`. Then click on the ![Render button](../images/render_button.png){.inline-icon}.
...
![Rendered quarto document](images/first_quarto_rendered.png){#fig-first_quarto_rendered .screenshot fig-alt="A screenshot of the whole Quarto document, which is available in HTML format as data/quarto_doc.html"}

As our code becomes more complicated, the value of using Quarto will become much clearer.

:::

## Formatting text in Quarto {#sec-formatting_quarto .rec}
...
## Performing analysis in Quarto {#sec-analysis_in_quarto .rec}

[**Recommended**]{.rec-text}

[↑ top](#)

We will now do a short data analysis exercise in a new Quarto document.

::: {.callout-exercise #ex-quarto .rec}

### Analysis in Quarto

[**Recommended**]{.rec-text}

The Human Protein Atlas (HPA) is a research project which was initiated in 2003 with the aim of mapping all the human proteins in cells, tissues, and organs using  various omics technologies.
...
### Advanced Quarto formatting {#sec-advanced_quarto_formatting .fold .extension}

::: {.callout-exercise #ex-advanced_quarto_formatting .extension}

### Advanced Quarto formatting

[**Extension**]{.extension-text}

Your `hpa_quarto.qmd` Quarto document currently produces a very simple HTML report. Explore the [Quarto documentation](https://quarto.org/docs/authoring/) and improve your report by adding at least three features that we have not covered.
...
Choose features that you think make the report more useful or easier to read.

:::

[secret]: Bonus secret-seekers - congratulations! You found the hidden message. 🚀 Please reward yourself with a biscuit.

::: {.callout-exercise #ex-advanced_quarto_formatting2 .bonus}

### See how the sausage is made

[**Bonus**]{.bonus-text}

This document is written in Quarto. The source code is available [here](https://github.com/UoC-MB1A/MB1A_Practicals_2026_2027/blob/main/materials/Practical_1_Introduction_to_R/01-02_quarto.qmd). 

By looking at the source code, see if you can figure out how:

* Exercises are assigned as core, recommended, extension or bonus.
* Exercises and answers are structured.
* Links to other sections of the document are created.

I have hidden a secret message in the source code - see if you can find it.
:::

## Documenting and formatting your code {#sec-documenting_and_formatting_your_code .core}

[**Core**]{.core-text}

[↑ top](#)

### Documentation {#sec-documentation .core}

It's always a good idea to add explanations to your code. We can do so in Quarto, by writing a description of what we're trying to do, as you did above.
...
Documenting your code is almost always helpful. What makes sense to you in that moment, might not a week later. Similarly, when sharing code with colleagues and collaborators, it's always good to be as clear as possible.

### Formatting your code {#sec-formatting_code .core}
...
* Helps you to structure your code
...
::: {.callout-exercise #ex-formatting .rec}
...
::: {.callout-exercise #ex-formatting_ext .extension}

### Manual formatting

[**Extension**]{.extension-text}

Look through the [tidyverse style guide](https://style.tidyverse.org/syntax.html) and format your code in the HPA data Quarto document manually. Save the document and render it again. Did you change anything that the Addin did not change?

:::

::: {.callout-exercise #ex-formatting_bon .bonus}

### Comparing styles between languages

[**Bonus**]{.bonus-text}

Look through the [tidyverse style guide](https://style.tidyverse.org/syntax.html) - does anything here surprise you compared to languages you've used previously?
...
## Summary
* Quarto documents combine **text, code and output** to create clear and reproducible analyses.
* R code can be run directly within **code chunks** in a Quarto document.
* **Clear documentation and formatting** make code easier to understand, check and reuse.
:::
