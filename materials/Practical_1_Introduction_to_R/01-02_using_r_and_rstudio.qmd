...
## The console, scripts and markdown {#sec-console_scripts_markdown}
...
The Human Protein Atlas (HPA) is a programme which was initiated in 2003 with the aim to map all the human proteins in cells, tissues, and organs using  various omics technologies.
...
Where you need to give something a name in R, it is helpful to use a name which describes what it is. For example, rather than `x <- 12` it is preferable to write e.g. `mean_size <- 12`.
...
- We can code interactively in the **console**.
