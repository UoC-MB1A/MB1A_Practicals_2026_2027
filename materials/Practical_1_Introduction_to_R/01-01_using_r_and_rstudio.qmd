...
If you've never programmed before, don't worry about the extension and bonus material in this practical! The material marked **core** is all you will need to progress through this course. You're advised to read the material marked **recommended** and attempt any exercises if you have time, but it is not essential. 

If you are an experienced programmer, please still read all of the core and recommended materials to understand the difference between R and other programming languages, and how we will interact with R in these practicals. However, if you are confident you do not need to complete all of the introductory exercises in parts 3 and 4. Instead, there are extension (marked with a magnifying glass) and bonus (marked with a rocket) exercises for you to try.

If you are somewhere in between, please read all of the core and recommended materials and choose whichever exercises feel more helpful to you. 
:::
...
::: {#ex-creating_objects .callout-exercise}
{{< fa solid anchor >}}
...
![The welcome screen of RStudio](images/rstudio_no_source.png){width="100%"}
...
![The source and console panels](images/rstudio_with_source.png){#fig-rstudio_labelled .screenshot}
...
:::: {#ex-first_script .callout-exercise}
{{< fa solid anchor >}}
