...
- @sec-fitting_linear_models_cat
- @sec-visualising_linear_models_cat
- @sec-anova_cat
- @sec-summary_0402
:::
...
## Examining data {#sec-examining_data}
...
We will keep coming back to this data frame, so let's save it in our `data` directory.

```{r save_ht}
write_csv(ht_df, "data/ht_df.csv")
```
...
## Choosing a test {#sec-choose_test}
...
## Running statistical tests in R {#sec-run_test}
...
## Extension exercise - the t-distribution {#sec-t_dist}
...
## Linear models {#sec-linear_models_cat}
...
### Fitting linear models in R {#sec-fitting_linear_models_cat}
...
### Visualising linear models in R {#sec-visualising_linear_models_cat}
